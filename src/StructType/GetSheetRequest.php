...
/**
 * This class stands for getSheetRequest StructType
 * @subpackage Structs
 */
class GetSheetRequest extends AbstractStructBase
{
    /**
     * The auth
    ...
    public $sheetId;
    /**
     * Constructor method for getSheetRequest
     * @uses GetSheetRequest::setAuth()
     * @uses GetSheetRequest::setSheetId()
     ...
     * Set auth value
     * @param \Unio\SlovakPost\StructType\AuthType $auth
     * @return \Unio\SlovakPost\StructType\GetSheetRequest
     */
