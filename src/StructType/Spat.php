...
/**
 * This class stands for Spat StructType
 * @subpackage Structs
 */
class Spat extends AbstractStructBase
{
    /**
     * The Meno
    ...
    public $Krajina;
    /**
     * Constructor method for Spat
     * @uses Spat::setMeno()
     * @uses Spat::setOrganizacia()
     * @uses Spat::setUlica()
     * @uses Spat::setMesto()
     * @uses Spat::setPSC()
     * @uses Spat::setKrajina()
     * @param string $meno
     ...
     */
    public function __construct($meno = null, $organizacia = null, $ulica = null, $mesto = null, $pSC = null, $krajina = null)
    {
        $this
            ->setMeno($meno)
     ...
     * Set Meno value
     * @param string $meno
     * @return \Unio\SlovakPost\StructType\Spat
     */
